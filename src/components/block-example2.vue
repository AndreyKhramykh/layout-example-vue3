<template>
    <div class="wrapper">
        <div class="container container_empty"></div>
        <div class="container">
            <div class="content">
                <h3>Spain</h3>
                ...
                <div class="button button-hovered">Book now</div>
            </div>
        </div>
    </div>
</template>
...
@import '@/assets/styles/blueButton.scss';

.wrapper {
    background-image: url(@/assets/backgrounds/image3.png);
